    ...
    <jet-action-section>
        ...
        <template #content>
            ...
            >
                ...
                <template #content>
                    Voulez-vous vraiment supprimer votre compte? Une fois votre
                    compte supprimé, toutes ses ressources et données seront
                    définitivement supprimées. Veuillez saisir votre mot de
